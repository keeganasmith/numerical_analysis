...
\end{align*}
We are trying to minimize this function with respect to $g(x) = 0$, so we will use Lagrange multipliers and solve the system of equations: \\
\begin{align*}
\nabla f(x) - \lambda \nabla g(x) &= 0 \\
g(x) &= 0
\end{align*}
...
\begin{align*}
\nabla f(x) &= \begin{bmatrix}
2x_1 \cdot \frac{1}{2}(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} \\
2(x_2 - \frac{1}{2}) \cdot \frac{1}{2}(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} \\
\end{bmatrix}\\
&= \begin{bmatrix}
x_1(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} \\
(x_2 - \frac{1}{2})(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} \\
\end{bmatrix}
\end{align*}
$\nabla g(x)$: \\
\begin{align*}
...
\begin{align*}
\begin{bmatrix}
x_1(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} - \lambda (3x_1^2 - 1) \\
(x_2 - \frac{1}{2})(x_1^2 + (x_2 - \frac{1}{2})^2)^{-\frac{1}{2}} - \lambda (-2x_2) \\
